...
RenderableObject::RenderableObject(float *vertices_array, int vertices_array_size, unsigned int *indices_array, int indices_array_size, const std::string &texture_path) : texture(Texture(texture_path))
{
